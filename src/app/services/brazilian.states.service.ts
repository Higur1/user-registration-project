...
export class BrazilianStatesService {
    private readonly statesList: BrazilianStatesListResponse = [
        ...
        { id: 32, descricao: 'Espirito Santo', descricaoContraida: 'ES' },
    ...
    getStates(): Observable<BrazilianStatesListResponse> {
